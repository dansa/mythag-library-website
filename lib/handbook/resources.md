...
### Chaos {.tier .text-center style="background-color: var(--md-realms-chaos);"}
...
### Aequor {.tier .text-center style="background-color: var(--md-realms-aequor);"}
...
### Caro {.tier .text-center style="background-color: var(--md-realms-caro);"}
...
### Ultra {.tier .text-center style="background-color: var(--md-realms-ultra);"}
...
![](/images/handbook/resources/limited-banner.png){width="384" loading=lazy}
...
<figure markdown="span">
  ![](/images/handbook/resources/events.png){width="400" loading=lazy}
</figure>
...
![](/images/icons/exp/gnosis-elixir-3.png){width="80" loading=lazy}
![](/images/icons/exp/gnosis-elixir-2.png){width="80" loading=lazy}
![](/images/icons/exp/gnosis-elixir-1.png){width="80" loading=lazy}
...
![](/images/icons/skills/aetheric-stone.png){width="80" loading=lazy}
![](/images/icons/skills/faded-crystalfly.png){width="80" loading=lazy}
![](/images/icons/skills/short-sea-lily.png){width="80" loading=lazy}
...
![](/images/handbook/resources/soulforge-aptitude.png){width="384" loading=lazy}
...
![](/images/handbook/resources/madness-omen.png){width="384" loading=lazy}
...
![](/images/handbook/resources/gnostic-potential.png){width="384" loading=lazy}
...
![](/images/icons/shop/radix-sediment.png){width="128" loading=lazy}
...
![](/images/icons/shop/d-jewel.png){width="128" loading=lazy}
...
![](/images/icons/consumables/fated-capture.png){width="80" loading=lazy}

Sepirot and Fated Captures (obtained by spending real money) are random selectors. Just use them and see what you get.

![](/images/icons/consumables/ultra-mapping.png){width="80" loading=lazy}
![](/images/icons/consumables/ultra-prophecy.png){width="80" loading=lazy}
![](/images/icons/consumables/caro-birth.png){width="80" loading=lazy}
![](/images/icons/consumables/caro-whisper.png){width="80" loading=lazy}
![](/images/icons/consumables/aequor-mystery.png){width="80" loading=lazy}
![](/images/icons/consumables/aequor-codex.png){width="80" loading=lazy}
...
![](/images/handbook/resources/silver-prime-1.png){width="384" loading=lazy}
...
![](/images/handbook/resources/silver-prime-4.png){width="384" loading=lazy}
